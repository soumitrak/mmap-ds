...
public class JenkinsHash {
    ...
    private static byte[] itoba(int value) {
        return new byte[]{
                (byte) (value >>> 24),
                (byte) (value >>> 16),
                (byte) (value >>> 8),
    ...
    private static byte[] ltoba(long value) {
        return new byte[]{
                (byte) (value >>> 56),
                (byte) (value >>> 48),
                (byte) (value >>> 40),
    ...
    public static int hash32(final long value) {
        return Math.abs(hash32(ltoba(value)));
    }

    public static int hash32(final int value) {
        return Math.abs(hash32(itoba(value)));
    }
     ...
     */
    private static long hash64(byte[] input) {
        int pc = 0;
        int pb = 0;
     ...
     */
    private static int hash32(byte[] input) {
        int pc = 0;
        int pb = 0;
     ...
     * @return 32-bit hash value.
     */
    private static int hashLittle(byte[] input, int length, int pc) {
     ...
     * @return 64-bit hash value.
     */
    private static long hashLittle2(byte[] input, int length, int pc, int pb) {
